...
(16)ExploitingBackgroundInformationNetworkstoEnhanceBilingualEventExtractionThroughTopicModeling
...
(23)MCMC方法及在贝叶斯统计中的应用
(24)Name Tagging
(25)NMF 算法
(26)PLSA及EM算法LDA
(27)Research trends analysis by comparing data mining
(28)RothschildPOQ2009(预测奥斯卡)
(29)Simple and Deterministic Matrix Sketching
(30)StatSnowballaStatisticalApproachtoExtractingEntityRelationships
(31)SVD
(32)svd-application
(33)Understanding Social Media
(34)百度主题感兴趣方向
(35)概率语言模型及其变形系列(LDA_Gimbbs)
(36)机器学习导论
(37)机器学习与数据挖掘
(38)潜在语义分析（LSA）
(39)数据科学入门必读的7篇重要论文
...
(12)Evaluating_collaborative_filtering_recommender_systems
...
(5)Website-orientedrecommendationbasedonheatspreadingandtag-awarecollaborativefiltering
(6)个性化推荐系统的研究进展
(7)个性化推荐系统评价方法综述
(8)推荐系统的循序渐进读物
...
(12)OpinionSpamDetectionDetectingFakeReviewsandReviewers
...
(10)Modular_networks_of_word_correlations_on_Twitter
...
(6)Map-Matching for Low-Sampling-Rate GPS Trajectories-cameraReady (1)
(7)Mining Large-Scale, Sparse GPS Traces for Map Inference
(8)On Discovery of Gathering Patterns from Trajectories
(9)On_Socio-Spatial_Group_Query_for_Location-Based_Social_Networks
